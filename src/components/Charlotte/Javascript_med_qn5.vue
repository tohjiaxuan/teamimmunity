      ...
      <b-row>
        ...
        <b-col cols='7' class='second-section p-5' >
          ...
          <b-row>
            ...
            <b-col align='right' >
              <b-button variant="outline-dark" id = "next" @click="$bvModal.show('complete')" v-on:click='addBadge(); updateProgress(selected, 65); incrementActivity("javascript medium")'> Complete </b-button>
