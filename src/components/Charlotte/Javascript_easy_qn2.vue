      ...
      <b-row>
        ...
        <b-col cols='7' class='second-section p-5' >
            ...
            <b-col align='right'>
                ...
                <b-collapse id="collapse-2" class="mt-2" >
                  <b-card>
                    <div>
                      <p class="text-left">
                      <span id='text' v-if="selected =='correct'"> Good job! A while loops checks for the condition first before executing the looping statements </span>
          ...
          <b-row>
            ...
            <b-col align='left' >
              <router-link to="/Javascript_easy_qn1" >
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 42)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
  ...
  created() {
    this.incrementClick("exercise_javascript_easy_2")
    this.updateCurrentlyOn('Javascript (Easy) Question 2')
    this.updateRecommended('Javascript (Easy) Question 3')
  }
}
