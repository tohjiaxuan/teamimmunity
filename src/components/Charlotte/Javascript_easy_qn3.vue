        ...
        <b-col cols='7' class='second-section p-5' >
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 43)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
  ...
  created() {
    this.incrementClick("exercise_javascript_easy_3")
    this.updateCurrentlyOn('Javascript (Easy) Question 3')
    this.updateRecommended('Javascript (Easy) Question 4')
  }
}
