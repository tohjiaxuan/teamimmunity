      ...
      <b-row>
        ...
        <b-col cols='7' class='second-section p-5' >
            ...
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> The loop iterates through the entire string </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
            ...
            <b-col align='right'>
                ...
                <b-collapse id="collapse-2" class="mt-2" >
                  <b-card>
                    <div>
                      <p class="text-left">
                      <span id='text' v-if="selected =='correct'"> Good job! i.upper() changes the entire string to uppercase. </span>
          ...
          <b-row>
            ...
            <b-col align='right' >
              <router-link to="/Py_med_qn2" >
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 81)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: 'a b c d', value: 'wrong', },
            { text: 'Error', value: 'wrong'},
            { text: 'a B c', value: 'wrong'},
            { text: 'A B C D', value: 'correct'},
  ...
  created() {
    this.incrementClick("exercise_python_med_1")
    this.updateCurrentlyOn('Python (Medium) Question 1')
    this.updateRecommended('Python (Medium) Question 2')
  }
}
