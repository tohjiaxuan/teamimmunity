        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 5: Static Variable </span>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                <p id="description"> Which of the following statements is false? </p>

                <b-button v-b-toggle.collapse-1 variant="primary"> Hint </b-button>
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> When a variable is declared as static, then a single copy of the variable is created and shared among all objects at a class level </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col> 
          ...
          <b-row>
            ...
            <b-col align='right' >
              <b-button variant="outline-dark" id = "next" @click="$bvModal.show('complete')" v-on:click='addBadge(); updateProgress(); incrementActivity("java medium")'> Complete </b-button>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: 'Static variables can be accessed using class name', value: 'wrong'},
            { text: 'Static variables can be accessed by static and non static methods', value: 'wrong'},
            { text: 'Static variables are specific to that instance of a class', value: 'correct'},
            { text: 'Static variable is a global variable', value: 'wrong'}
          ]
        }
    },
    components: {
  ...
  created() {
    this.incrementClick("exercise_java_med_5")
    this.updateCurrentlyOn('Java (Medium) Question 5')
    this.updateRecommended('Java (Hard) Question 1')
  }
}
