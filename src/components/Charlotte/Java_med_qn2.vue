        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 2: While Loop </span>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <pre> <code> <br> class whileLoopDemo {
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> When the condition becomes false, the loop terminates </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 22)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: '7 6 5', value: 'correct'},
            { text: '7 6 5 4', value: 'wrong'},
            { text: '7 6', value: 'wrong'},
            { text: '765', value: 'wrong'}
          ]
        }
    },
    components: {
  ...
  created() {
    this.incrementClick("exercise_java_med_2")
    this.updateCurrentlyOn('Java (Medium) Question 2')
    this.updateRecommended('Java (Medium) Question 3')
  }
}
