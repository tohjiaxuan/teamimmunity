            ...
            <b-col align='right'>
                ...
                <b-collapse id="collapse-2" class="mt-2" >
                  <b-card>
                    <div>
                      <p class="text-left">
                      <span id='text' v-if="status =='correct'"> Good job! For nexted loops, the programme first encounters the outer loop, executing its first iteration. 
...
export default {
  ...
  created() {
    ...
    this.updateCurrentlyOn('Python (Medium) Question 5')
    this.updateRecommended('Python (Hard) Question 1')
  }
}
