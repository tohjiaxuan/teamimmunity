        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 5: Access Modifiers </span>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                <p id="description"> Rank the access modifiers in the increasing order of their visibility </p>
            

                <b-button v-b-toggle.collapse-1 variant="primary"> Hint </b-button>
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> Consider the visibility of each modifier </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col> 
          ...
          <b-row>
            ...
            <b-col align='right' >
              <b-button variant="outline-dark" id = "next" @click="$bvModal.show('complete')" v-on:click='addBadge(); updateProgress(selected, 35); incrementActivity("java hard")'> Complete </b-button>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: 'private, default, protected, public', value: 'correct'},
            { text: 'private, protected, public, default', value: 'wrong'},
            { text: 'protected, private, default, public', value: 'wrong'},
            { text: 'protected, private, public, default', value: 'wrong'}
          ]
        }
    },
    components: {
  ...
  created() {
    this.incrementClick("exercise_java_hard_5")
    this.updateCurrentlyOn('Java (Hard) Question 5')
