        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 2: Pattern Matching </span>
            </b-col>
          </b-row>
        ...
        <b-row>
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 62)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
  ...
  created() {
    this.incrementClick("exercise_javascript_hard_2")
    this.updateCurrentlyOn('Javascript (Hard) Question 2')
    this.updateRecommended('Javascript (Hard) Question 3')
  }
}
