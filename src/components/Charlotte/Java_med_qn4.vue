        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 4: Break </span>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <pre> <code> <br> public class BreakExample { 
                <br> public static void main(String[] args) {   
                <br> for(int i=9;i>3;i--){  
                <br>  if(i==5){  
                <br>    break;  
                <br>   }
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> Loop is broken when it satisfies the break statement </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
          ...
          <b-row>
            ...
            <b-col align='left' >
              <router-link to="/Java_med_qn3" >
              <b-button variant="outline-dark" id = "next" > Back </b-button>
              </router-link>
              </b-col>
            
            <b-col align='right' >
              <router-link to="/Java_med_qn5" >
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 24)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: '9 8 7 6 5', value: 'wrong'},
            { text: '9 8 7 6', value: 'correct'},
            { text: '9 8 7 6 5 4 3', value: 'wrong'},
            { text: '9 8 7 6 5 4', value: 'wrong'}
          ]
        }
    },
    components: {
  ...
  created() {
    this.incrementClick("exercise_java_med_4")
    this.updateCurrentlyOn('Java (Medium) Question 4')
    this.updateRecommended('Java (Medium) Question 5')
  }
}
