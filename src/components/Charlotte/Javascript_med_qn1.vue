        ...
        <b-col cols='7' class='second-section p-5' >
            ...
            <b-col align='right'>
                ...
                <b-collapse id="collapse-2" class="mt-2" >
                  <b-card>
                    <div>
                      <p class="text-left">
                      <span id='text' v-if="selected =='correct'"> Good job! JSON.parse()throws a SyntaxError exception if the string to parse is not valid JSON.</span>
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 51)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
  ...
  created() {
    this.incrementClick("exercise_javascript_med_1")
    this.updateCurrentlyOn('Javascript (Medium) Question 1')
    this.updateRecommended('Javascript (Medium) Question 2')
  }
}
