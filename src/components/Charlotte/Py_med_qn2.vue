            ...
            <b-col>
               <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> While loop will break if the condition is not met </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: '14 13 12 11 10', value: 'correct'},
            { text: '15 14 13 12 11 10', value: 'wrong'},
            { text: '1413121110', value: 'wrong'},
            { text: '15 14 13 12 11 10 9', value: 'wrong'}
          ]
        }
    },
    components: {
  ...
  created() {
    ...
    this.updateCurrentlyOn('Python (Medium) Question 2')
    this.updateRecommended('Python (Medium) Question 3')
  }
}
