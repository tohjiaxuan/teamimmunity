        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 4: Array </span>
            </b-col>
          </b-row>
            ...
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> For loop runs through the entire array </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
            ...
            <b-col align='right'>
                ...
                <b-collapse id="collapse-2" class="mt-2" >
                  <b-card>
                    <div>
                      <p class="text-left">
                      <span id='text' v-if="selected =='correct'"> Good job! The for loop runs through the entire array and each integer is printed out. </span>
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 14)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: '33345', value: 'wrong'},
            { text: '33 3 4 5', value: 'correct'},
            { text: '4', value: 'wrong'},
            { text: '33', value: 'wrong'}
          ]
        }
  ...
  created() {
    this.incrementClick("exercise_java_easy_4")
    this.updateCurrentlyOn('Java (Easy) Question 4')
    this.updateRecommended('Java (Easy) Question 5')
  }
}
