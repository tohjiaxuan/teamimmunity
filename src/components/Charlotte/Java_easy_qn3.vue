        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 3: Typecasting </span>
            </b-col>
          </b-row>
            ...
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> Float to int is a form of narrow typecasting </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 13)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: '10.0', value: 'wrong'},
            { text: '10.5', value: 'wrong'},
  ...
  created() {
    this.incrementClick("exercise_java_easy_3")
    this.updateCurrentlyOn('Java (Easy) Question 3')
    this.updateRecommended('Java (Easy) Question 4')
  }
}
