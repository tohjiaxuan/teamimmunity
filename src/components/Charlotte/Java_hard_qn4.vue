        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 4: Method Overriding </span>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <pre> <code> <br> class Vehicle {  
                <br> void run() {
                <br>   System.out.println("Vehicle is running");
                <br> }}  
                <br> class Bike2 extends Vehicle {  
                <br> void run( ) {
                <br>   System.out.println("Bike is running safely");
                <br> }  
                <br> public static void main(String args[]) {  
                <br>   Bike2 obj = new Bike2();
                <br>   obj.run();
                <br> }}
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> Method overriding is used to provide the specific implementation of a method which is already provided by its superclass </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
          ...
          <b-row>
            ...
            <b-col align='right' >
              <router-link to="/Java_hard_qn5" >
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 34)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: 'Vehicle is running', value: 'wrong'},
            { text: 'Bike is running safely', value: 'correct'},
  ...
  created() {
    this.incrementClick("exercise_java_hard_4")
    this.updateCurrentlyOn('Java (Hard) Question 4')
    this.updateRecommended('Java (Hard) Question 5')
  }
}
