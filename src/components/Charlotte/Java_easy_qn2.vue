        ...
        <b-col cols='7' class='second-section p-5' >
            ...
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> Variable y has not been defined </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 12)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: 'None of the above', value: 'correct'},
            { text: '10', value: 'wrong'},
            { text: '9', value: 'wrong'},
            { text: '15', value: 'wrong'}
          ]
  ...
  created() {
    this.incrementClick("exercise_java_easy_2")
    this.updateCurrentlyOn('Java (Easy) Question 2')
    this.updateRecommended('Java (Easy) Question 3')
  }
}
