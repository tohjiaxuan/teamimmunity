        ...
        <b-col cols='7' class='second-section p-5' >
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 11)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
    ...
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: 'int -5', value: 'wrong', },
            { text: 'int -4', value: 'wrong'},
            { text: 'double -4.5', value: 'wrong'},
            { text: 'double -5.0', value: 'correct'},
