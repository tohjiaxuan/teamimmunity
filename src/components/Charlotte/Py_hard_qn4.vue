        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 4: Tuple </span>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <pre> <code> <br> tuple = (1, 2, 3, 4) 
                <br> tuple.append((5, 6, 7))
                <br> print(len(tuple))
                ...
                <b-collapse id="collapse-1" class="mt-2">
                  <b-card>
                    <p class="card-text"> Tuples are immutable </p>
                  </b-card>
                </b-collapse>
              </div>
            </b-col>
            ...
            <b-col align='right'>
                ...
                <b-collapse id="collapse-2" class="mt-2" >
                  <b-card>
                    <div>
                      <p class="text-left">
                      <span id='text' v-if="selected =='correct'"> Good job! Tuples are immutable therefore they do not have the function append. </span>
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 94)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
