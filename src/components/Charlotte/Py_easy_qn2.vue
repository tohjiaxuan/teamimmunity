        ...
        <b-col cols='7' class='second-section p-5' >
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 72)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
  ...
  created() {
    this.incrementClick("exercise_python_easy_2")
    this.updateCurrentlyOn('Python (Easy) Question 2')
    this.updateRecommended('Python (Easy) Question 3')
  }
}
