      ...
      <b-row>
        ...
        <b-col cols='7' class='second-section p-5' >
          ...
          <b-row>
            ...
            <b-col align='right' >
              <router-link to="/Py_easy_qn5" >
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 74)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
  ...
  created() {
    this.incrementClick("exercise_python_easy_4")
    this.updateCurrentlyOn('Python (Easy) Question 4')
    this.updateRecommended('Python (Easy) Question 5')
  }
}
