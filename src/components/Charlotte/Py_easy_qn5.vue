      ...
      <b-row>
        ...
        <b-col cols='7' class='second-section p-5' >
            ...
            <b-col align='right'>
                ...
                <b-collapse id="collapse-2" class="mt-2" >
                  <b-card>
                    <div>
                      <p class="text-left">
                      <span id='text' v-if="selected =='correct'"> Good job! Nested list will still be a list when sliced.</span>
          ...
          <b-row>
            ...
            <b-col align='right' >
              <b-button variant="outline-dark" id = "next" @click="$bvModal.show('complete')" v-on:click='addBadge(); updateProgress(selected, 75); incrementActivity("python easy")'> Complete </b-button>
...
export default {
  ...
  created() {
    this.incrementClick("exercise_python_easy_5")
    this.updateCurrentlyOn('Python (Easy) Question 5')
    this.updateRecommended('Python (Medium) Question 1')
  }
}
