        ...
        <b-col cols='7' class='second-section p-5' >
            ...
            <b-col align='right'>
                ...
                <b-collapse id="collapse-2" class="mt-2" >
                  <b-card>
                    <div>
                      <p class="text-left">
                      <span id='text' v-if="selected =='correct'"> Good job! Dictionary holds key:value pair. To access the value, we can use the get() method or simply accessing it x = thisdict["model"]. </span>
          ...
          <b-row>
            ...
            <b-col align='right' >
              ...
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 84)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
  ...
  created() {
    this.incrementClick("exercise_python_med_4")
    this.updateCurrentlyOn('Python (Medium) Question 4')
    this.updateRecommended('Python (Medium) Question 5')
  }
}
