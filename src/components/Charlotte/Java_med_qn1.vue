        ...
        <b-col cols='7' class='second-section p-5' >
          <b-row>
            <b-col align='center' class='pt-5 pb-5'>
              <span id='qn'> Question 1: For Loop </span>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col>
              <div id="grey1" class="shadow-lg p-3 mb-5 bg-grey rounded">
                ...
                <pre> <code> <br> class forLoopDemo {
                <br> public static void main(String args[]) {
                <br>   for (int x = 2; x = 4; x++) 
          ...
          <b-row>
            ...
            <b-col align='right' >
              <router-link to="/Java_med_qn2" >
              <b-button variant="outline-dark" id = "next" v-on:click='updateProgress(selected, 21)'> Next </b-button>
              </router-link>
              </b-col>
          </b-row>
        </b-col>
...
export default {
    data() {
        ...
        return {
          ...
          options: [
            ...
            { text: '2 3 4', value: 'correct', },
            { text: '2 3', value: 'wrong'},
            { text: '234', value: 'wrong'},
            { text: '23', value: 'wrong'},
  ...
  created() {
    this.incrementClick("exercise_java_med_1")
    this.updateCurrentlyOn('Java (Medium) Question 1')
    this.updateRecommended('Java (Medium) Question 2')
  }
}
